...
TEST(Bitwise, GetSetBit) {
    ...
    Aesi u1 = "28532736677951985108511975536651973171.";
    ...
    Aesi u2 = "202963489620510457840756855970746955719.";
    ...
    Aesi u3 = "99039543241645718481744753772010007488.";
    ...
    Aesi u4 = "185521423754314153400893953240556219688.";
    ...
    Aesi u5 = "212276592061158741188353364055816027621.";
    ...
    Aesi u6 = "29771602601962196722470093116016540190.";
    ...
    Aesi u7 = "37894586767282899313108693355181559199.";
    ...
    Aesi u8 = "132933768221848679423944309756035959186.";
    ...
    Aesi u9 = "112312108742573550610800981189693677283.";
    ...
    Aesi<512> o0{}; o0.setBit(36, true); o0.setBit(233, true); o0.setBit(68, true);
    ...
    Aesi<512> o1{}; o1.setBit(40, true); o1.setBit(43, true); o1.setBit(101, true);
    EXPECT_EQ(o1, "2535301200456458812889011060736.");
    o1.setBit(40, false); o1.setBit(43, false); o1.setBit(101, false); EXPECT_EQ(o1, 0);

    Aesi<512> o2{}; o2.setBit(467, true); o2.setBit(34, true); o2.setBit(143, true);
    ...
    Aesi<512> o3{}; o3.setBit(50, true); o3.setBit(122, true); o3.setBit(142, true);
    ...
    Aesi<512> o4{}; o4.setBit(82, true); o4.setBit(393, true); o4.setBit(263, true);
    ...
    Aesi<512> o5{}; o5.setBit(15, true); o5.setBit(95, true); o5.setBit(300, true);
    ...
    Aesi<512> o6{}; o6.setBit(372, true); o6.setBit(454, true); o6.setBit(95, true);
    ...
    Aesi<512> o7{}; o7.setBit(207, true); o7.setBit(117, true); o7.setBit(413, true);
    ...
    Aesi<512> o8{}; o8.setBit(467, true); o8.setBit(453, true); o8.setBit(159, true);
    ...
    Aesi<512> o9{}; o9.setBit(58, true); o9.setBit(299, true); o9.setBit(348, true);
    ...
    Aesi<512> o10{}; o10.setBit(19, true); o10.setBit(138, true); o10.setBit(475, true);
    ...
    Aesi<512> o11{}; o11.setBit(77, true); o11.setBit(12, true); o11.setBit(475, true);
    ...
    Aesi<512> o12{}; o12.setBit(381, true); o12.setBit(286, true); o12.setBit(43, true);
    ...
    Aesi<512> o13{}; o13.setBit(337, true); o13.setBit(97, true); o13.setBit(201, true);
    ...
    Aesi<512> o14{}; o14.setBit(194, true); o14.setBit(425, true); o14.setBit(218, true);
    ...
    Aesi<512> o15{}; o15.setBit(344, true); o15.setBit(130, true); o15.setBit(455, true);
    ...
    Aesi<512> o16{}; o16.setBit(361, true); o16.setBit(305, true); o16.setBit(498, true);
    ...
    Aesi<512> o17{}; o17.setBit(239, true); o17.setBit(143, true); o17.setBit(338, true);
    ...
    Aesi<512> o18{}; o18.setBit(429, true); o18.setBit(244, true); o18.setBit(150, true);
    ...
    Aesi<512> o19{}; o19.setBit(342, true); o19.setBit(286, true); o19.setBit(46, true);
...
TEST(Bitwise, CountBitsBytes) {
    {
        Aesi m = 0; EXPECT_EQ(m.bitCount(), 0); EXPECT_EQ(m.byteCount(), 0);
    }{
        Aesi m = "8125433280239853252548211056150939786662988783355321803610299695202888531280061795935472804268151222945147553964613898040510775501409983.";
        EXPECT_EQ(m.bitCount(), 452); EXPECT_EQ(m.byteCount(), 57);
    }{
        Aesi m = "17574267251873162264218761220759873754600756500939123609416723673535177168061667995476463924261008261536776611267749.";
        EXPECT_EQ(m.bitCount(), 383); EXPECT_EQ(m.byteCount(), 48);
    }{
        Aesi m = "21802890716849309559167483785510602695344058930676827225663397326140604460817662307.";
        EXPECT_EQ(m.bitCount(), 274); EXPECT_EQ(m.byteCount(), 35);
    }{
        Aesi m = "131809808420798093069108302425012024571137335830720744893629509248644271768860200114478317853560728340486283732831799757717499791405.";
        EXPECT_EQ(m.bitCount(), 436); EXPECT_EQ(m.byteCount(), 55);
    }{
        Aesi m = "433465209374823396906000597351582380255601365637951225491.";
        EXPECT_EQ(m.bitCount(), 189); EXPECT_EQ(m.byteCount(), 24);
    }{
        Aesi m = "2629456433952760142429083664445582597876949492372857231139584353910376944544651100012259827002301897509955630054342321196527349466023286261.";
        EXPECT_EQ(m.bitCount(), 460); EXPECT_EQ(m.byteCount(), 58);
    }{
        Aesi m = "96406040941996537769947305839001509182667236508149012765337105619119234275587188230156962357657907962935261056152266015569090413578126311393192507827.";
        EXPECT_EQ(m.bitCount(), 495); EXPECT_EQ(m.byteCount(), 62);
    }{
        Aesi m = "779975898910398721588512843488292737216066708787279402842479265134130380576933342820188191171817284387486614000372261528684686600311889254943.";
        EXPECT_EQ(m.bitCount(), 469); EXPECT_EQ(m.byteCount(), 59);
    }{
        Aesi m = "235942049152378908081179353103850208970447097919975182053246678543156938370379557034727388517479366065434560109466574006814835006.";
        EXPECT_EQ(m.bitCount(), 427); EXPECT_EQ(m.byteCount(), 54);
    }{
        Aesi m = "201875921226053996734972115605743747569650032938025946229041017159355210997256571122101768564433281896618227162.";
        EXPECT_EQ(m.bitCount(), 367); EXPECT_EQ(m.byteCount(), 46);
    }{
        Aesi m = "15073045815333316943023135965557590030059580430131020419417594043252226785264218082879695545355297413008838849654297643522962831581276346739748452411005.";
        EXPECT_EQ(m.bitCount(), 503); EXPECT_EQ(m.byteCount(), 63);
    }{
        Aesi m = "4779143266357253920771631149725776855741684141203010232217393689880280981988983708.";
        EXPECT_EQ(m.bitCount(), 272); EXPECT_EQ(m.byteCount(), 34);
    }{
        Aesi m = "2073421040132906101606968078759317225438721792138284094607812513052260945297068866042052395426362224798695857992574.";
        EXPECT_EQ(m.bitCount(), 380); EXPECT_EQ(m.byteCount(), 48);
    }{
        Aesi m = "8056659416481504751897050853317416496949290710572167878886003741841335717120626786797209972094490663311696280531.";
        EXPECT_EQ(m.bitCount(), 372); EXPECT_EQ(m.byteCount(), 47);
    }{
        Aesi m = "2142462200685170464758953014183775179871969460337463575081194035221992317627132584005119954695168082695849861091.";
        EXPECT_EQ(m.bitCount(), 370); EXPECT_EQ(m.byteCount(), 47);
    }{
        Aesi m = "62436602421201799605543908261767952405552978341834407578470057072479070877359989051911219180730700900405485784333527578189654108644284314.";
        EXPECT_EQ(m.bitCount(), 455); EXPECT_EQ(m.byteCount(), 57);
    }{
        Aesi m = "8708886923751208896369646390414934986338160207927996314637234694235206909979086845075358681085923263473283036019941211939578987417.";
        EXPECT_EQ(m.bitCount(), 432); EXPECT_EQ(m.byteCount(), 54);
    }{
        Aesi m = "89350417268629761945311302081940817634086062965758014462352660629259870134745.";
        EXPECT_EQ(m.bitCount(), 256); EXPECT_EQ(m.byteCount(), 32);
    }{
        Aesi m = "947042416456442092300475377118864687689487941476858357893004304488139014532690257721893907183506176965809182242.";
        EXPECT_EQ(m.bitCount(), 369); EXPECT_EQ(m.byteCount(), 47);
    }{
        Aesi m = "51023079086295460865928137217812586222771465721882979976763630417920201452678256173660956.";
        EXPECT_EQ(m.bitCount(), 295); EXPECT_EQ(m.byteCount(), 37);
    }{
        Aesi m = "394659189019993910186127325893947611904290244834873046551135935656.";
        EXPECT_EQ(m.bitCount(), 218); EXPECT_EQ(m.byteCount(), 28);
    }{
        Aesi m = "37877413867687525478310222305154391480148401261437989997408830529823347525043333150254230178590071374435760769836732108165534044.";
        EXPECT_EQ(m.bitCount(), 424); EXPECT_EQ(m.byteCount(), 53);
    }{
        Aesi m = "238070679664433351272792579356666604707321803317863286672042730788775395964738812011349334479630745454353018796.";
        EXPECT_EQ(m.bitCount(), 367); EXPECT_EQ(m.byteCount(), 46);
    }{
        Aesi m = "267012496918653157167419170959622614804856381218193711762331242352905645916107540494367875074170692.";
        EXPECT_EQ(m.bitCount(), 327); EXPECT_EQ(m.byteCount(), 41);
    }{
        Aesi m = "1073603691947597544383478242209761023668674955975778069033461724734109933796134001131961241790993489349003858738008559432.";
        EXPECT_EQ(m.bitCount(), 399); EXPECT_EQ(m.byteCount(), 50);
    }{
        Aesi m = "562298521164442233158113896589082715246806788884332216264624631405816988860814005265019204093949261669027769520262704189761495475125709632881919.";
        EXPECT_EQ(m.bitCount(), 478); EXPECT_EQ(m.byteCount(), 60);
    }{
        Aesi m = "4158978421816859451128522099515091277614005938463674827112430404792191330568135712633235561579918390866268466676374544980567880949604447805648565.";
        EXPECT_EQ(m.bitCount(), 481); EXPECT_EQ(m.byteCount(), 61);
    }{
        Aesi m = "14924619216098556351851155524145079961383025330646663269574812166523143205418868252624810697655395.";
        EXPECT_EQ(m.bitCount(), 323); EXPECT_EQ(m.byteCount(), 41);
    }{
        Aesi m = "19263125433922139070353143174488847529421346973177209705127231844581796037119306630930585539489675909638996614473661956001635767638852.";
        EXPECT_EQ(m.bitCount(), 443); EXPECT_EQ(m.byteCount(), 56);
    }{
        Aesi m = "682806395672504228438313395837976674746610475712229974529528356835885995631486207670649897686632166147160247453750254696315344897085670207253.";
        EXPECT_EQ(m.bitCount(), 468); EXPECT_EQ(m.byteCount(), 59);
    }{
        Aesi m = "44165561608214009062731411641807426531080875031708.";
        EXPECT_EQ(m.bitCount(), 165); EXPECT_EQ(m.byteCount(), 21);
    }{
        Aesi m = "1810068275259181735129583643533689916163146029484908317346080710885725781416625194936179579160908146170735805.";
        EXPECT_EQ(m.bitCount(), 360); EXPECT_EQ(m.byteCount(), 45);
    }{
        Aesi m = "22203856399318573146469259769128778849626717054324.";
        EXPECT_EQ(m.bitCount(), 164); EXPECT_EQ(m.byteCount(), 21);
    }{
        Aesi m = "7694432564154108129168181465478548430868392855046604.";
        EXPECT_EQ(m.bitCount(), 173); EXPECT_EQ(m.byteCount(), 22);
    }{
        Aesi m = "1285401729605331393667176392943810500024205211000972253877823290865149302163170008070385888597921032464419651868028052643582626094727703773739.";
        EXPECT_EQ(m.bitCount(), 469); EXPECT_EQ(m.byteCount(), 59);
    }{
        Aesi m = "7965985649459576135397069050747352074976336307021856132905783547305822022499543909128907103263748211242642667.";
        EXPECT_EQ(m.bitCount(), 362); EXPECT_EQ(m.byteCount(), 46);
    }{
        Aesi m = "590007771335133157576169972021585528245811490226372057497198894444640402943288325.";
        EXPECT_EQ(m.bitCount(), 269); EXPECT_EQ(m.byteCount(), 34);
    }{
        Aesi m = "503140962366666306559517743623355538379506158349730754767227786462059097766284010030410635094454058647949382107093092344428041640646540768699921800282.";
        EXPECT_EQ(m.bitCount(), 498); EXPECT_EQ(m.byteCount(), 63);
    }{
        Aesi m = "3384777352685069629216151157031766989015071181826830603580543832463469699978010082081.";
        EXPECT_EQ(m.bitCount(), 281); EXPECT_EQ(m.byteCount(), 36);
    }{
        Aesi m = "7664372817785990326514266663237307917142062491158403533767880373365052616667133649.";
        EXPECT_EQ(m.bitCount(), 273); EXPECT_EQ(m.byteCount(), 35);
    }{
        Aesi m = "334215638884608286471654924286086692624854.";
        EXPECT_EQ(m.bitCount(), 138); EXPECT_EQ(m.byteCount(), 18);
    }{
        Aesi m = "34080246917087621931619781132472798534654778567128547384895677598758.";
        EXPECT_EQ(m.bitCount(), 225); EXPECT_EQ(m.byteCount(), 29);
    }{
        Aesi m = "29652837005697212319365507476545093089128339637930923529833544380900521909328030875059991197894410099757577321170398507.";
        EXPECT_EQ(m.bitCount(), 394); EXPECT_EQ(m.byteCount(), 50);
    }{
        Aesi m = "5507539735498776368361465467701902930055554588691378901463982655670782159582225073135111662243238408663182059630766021416042316106489465754074808853540974.";
        EXPECT_EQ(m.bitCount(), 511); EXPECT_EQ(m.byteCount(), 64);
    }{
        Aesi m = "3004975643443764126226151707508807531199878892716451932163126478736284424236635636281558878832196029.";
        EXPECT_EQ(m.bitCount(), 331); EXPECT_EQ(m.byteCount(), 42);
    }{
        Aesi m = "33813851846197160289962577402206813088513580354756664599207825023964752.";
        EXPECT_EQ(m.bitCount(), 235); EXPECT_EQ(m.byteCount(), 30);
    }{
        Aesi m = "377651090648098570965685387456182588498516.";
        EXPECT_EQ(m.bitCount(), 139); EXPECT_EQ(m.byteCount(), 18);
    }{
        Aesi m = "7410608557526364458156047672247498762540719035935927862959737209627950642463171897639112563283795045371205928539576466838870380014318225241722933868505375.";
        EXPECT_EQ(m.bitCount(), 512); EXPECT_EQ(m.byteCount(), 64);
    }{
        Aesi m = "10044990313301674850074738713697972584889987858.";
        EXPECT_EQ(m.bitCount(), 153); EXPECT_EQ(m.byteCount(), 20);
    }{
        Aesi m = "266099640168931550489566500155710899364300315367325913153890064383032281808.";
        EXPECT_EQ(m.bitCount(), 248); EXPECT_EQ(m.byteCount(), 31);
    }{
        Aesi m = "1482187387782878685086114755119507673273045170923240176317716983194935913741533035499712098299877.";
        EXPECT_EQ(m.bitCount(), 320); EXPECT_EQ(m.byteCount(), 40);
    }{
        Aesi m = "1173795849701350193393898818464811973771747962148586952799081909088.";
        EXPECT_EQ(m.bitCount(), 220); EXPECT_EQ(m.byteCount(), 28);
    }{
        Aesi m = "1075760111541429825505644691336694226487310.";
        EXPECT_EQ(m.bitCount(), 140); EXPECT_EQ(m.byteCount(), 18);
    }{
        Aesi m = "45171859382745997119719399550040468527765767975014522226860885063314372527502004679908084036170446028018456989547511984231472473256392440632.";
        EXPECT_EQ(m.bitCount(), 464); EXPECT_EQ(m.byteCount(), 58);
    }{
        Aesi m = "3550083230609724792508047331304227753793138230616730680629604946225570522563666068400196764430870432027087067680305391.";
        EXPECT_EQ(m.bitCount(), 391); EXPECT_EQ(m.byteCount(), 49);
    }{
        Aesi m = "238597071144511397377349027982816966185598914027694352122412323366822958481130189865972825210896.";
        EXPECT_EQ(m.bitCount(), 317); EXPECT_EQ(m.byteCount(), 40);
    }{
        Aesi m = "585583350737808456521626773441702619917565834.";
        EXPECT_EQ(m.bitCount(), 149); EXPECT_EQ(m.byteCount(), 19);
    }{
        Aesi m = "36049165193710656383674476318098849309081833966574925144648178032947125994642089205867044968998920577865084298839120084785200.";
        EXPECT_EQ(m.bitCount(), 414); EXPECT_EQ(m.byteCount(), 52);
    }{
        Aesi m = "19234485954353740431198448391386775220848294547901362245689574.";
        EXPECT_EQ(m.bitCount(), 204); EXPECT_EQ(m.byteCount(), 26);
    }{
        Aesi m = "14427157670805621590883010144772437273027.";
        EXPECT_EQ(m.bitCount(), 134); EXPECT_EQ(m.byteCount(), 17);
    }{
        Aesi m = "294592116837137192128962078358363421245896052688274598857112028471180048502021366005547689198067574009837.";
        EXPECT_EQ(m.bitCount(), 348); EXPECT_EQ(m.byteCount(), 44);
    }{
        Aesi m = "78014649575862615159507540438874452796220617919545457775300748208619982480459908586326061058242840934850085928995554769357091592190.";
        EXPECT_EQ(m.bitCount(), 435); EXPECT_EQ(m.byteCount(), 55);
    }{
        Aesi m = "4790741095386749449906937030566866031746046169304656278584923858487306270948959401572155081456882084125079092127248920113.";
        EXPECT_EQ(m.bitCount(), 401); EXPECT_EQ(m.byteCount(), 51);
    }{
        Aesi m = "633161550773844933515432109510252603991101078804467201160861966691510376183451.";
        EXPECT_EQ(m.bitCount(), 259); EXPECT_EQ(m.byteCount(), 33);
    }{
        Aesi m = "60122452179660513236341354307732611719576507171909615307390365442026320913187824739846223109852159341204602037787795321449601183014848534293967195178.";
        EXPECT_EQ(m.bitCount(), 495); EXPECT_EQ(m.byteCount(), 62);
    }{
        Aesi m = "161995631938575534869925629985890633415808895867596764222761722202191754575.";
        EXPECT_EQ(m.bitCount(), 247); EXPECT_EQ(m.byteCount(), 31);
    }{
        Aesi m = "911446817435997746933062831691885516611915352665999458511930156309284363237318454237971176312159689716360014561389228715376718662509862481060645832339.";
        EXPECT_EQ(m.bitCount(), 499); EXPECT_EQ(m.byteCount(), 63);
    }{
        Aesi m = "6823785331803106103597794618266911145262172838581223.";
        EXPECT_EQ(m.bitCount(), 173); EXPECT_EQ(m.byteCount(), 22);
    }{
        Aesi m = "155239918270315971266524910862097900140673811776184706157309200861937455.";
        EXPECT_EQ(m.bitCount(), 237); EXPECT_EQ(m.byteCount(), 30);
    }{
        Aesi m = "31791717464914174502002045742730878568603229720932639534325451917358893334089540214885596440815774662097524.";
        EXPECT_EQ(m.bitCount(), 354); EXPECT_EQ(m.byteCount(), 45);
    }{
        Aesi m = "1003586762829871808712634204549567450358275489539260017484895107722613982163260348845481532808575114339347311595215.";
        EXPECT_EQ(m.bitCount(), 379); EXPECT_EQ(m.byteCount(), 48);
    }{
        Aesi m = "4880164245754362338097205112813929292550604675359560497016587.";
        EXPECT_EQ(m.bitCount(), 202); EXPECT_EQ(m.byteCount(), 26);
    }{
        Aesi m = "19749483887303390161030962495768683795272790.";
        EXPECT_EQ(m.bitCount(), 144); EXPECT_EQ(m.byteCount(), 18);
    }{
        Aesi m = "63148738539734553392341133462985836036740639371798360597452567097525683306066658917516309566802305685801145960072360549701.";
        EXPECT_EQ(m.bitCount(), 405); EXPECT_EQ(m.byteCount(), 51);
    }{
        Aesi m = "107590342114875162918348472307699251018874103592474832066873484053754113708388326214150395.";
        EXPECT_EQ(m.bitCount(), 296); EXPECT_EQ(m.byteCount(), 37);
    }{
        Aesi m = "6698953979797583020827904972213947616977062455698932958829035301051011495115.";
        EXPECT_EQ(m.bitCount(), 252); EXPECT_EQ(m.byteCount(), 32);
    }{
        Aesi m = "5430207379526057381214725804197658314755709506858996920618690886502342024339746344612062226768199148738037128023372725688185796337503888328.";
        EXPECT_EQ(m.bitCount(), 461); EXPECT_EQ(m.byteCount(), 58);
    }{
        Aesi m = "48581874368844478342704760472464069633282490659897264814743946699473.";
        EXPECT_EQ(m.bitCount(), 225); EXPECT_EQ(m.byteCount(), 29);
    }{
        Aesi m = "125649816413620037750566080548892812403575569822422682828388593453790534195113364133371382224759702685614495034150.";
        EXPECT_EQ(m.bitCount(), 376); EXPECT_EQ(m.byteCount(), 47);
    }{
        Aesi m = "9090966395883606169412743491416218582727668678050520137422123160210277873679028562444511041122860878620562547703977100496584276850469220021458.";
        EXPECT_EQ(m.bitCount(), 472); EXPECT_EQ(m.byteCount(), 59);
    }{
        Aesi m = "174662122049287992457319598417451937883451980333462349197.";
        EXPECT_EQ(m.bitCount(), 187); EXPECT_EQ(m.byteCount(), 24);
    }{
        Aesi m = "813507411993390554879828672051435218814298367924349835202824439987190213087714864429892828655932570189200528471003010841188643835728860126206357.";
        EXPECT_EQ(m.bitCount(), 479); EXPECT_EQ(m.byteCount(), 60);
    }{
        Aesi m = "318619099993310255354692135487104214301662979.";
        EXPECT_EQ(m.bitCount(), 148); EXPECT_EQ(m.byteCount(), 19);
    }{
        Aesi m = "1777693857708080545844538076702187890341442968457518484.";
        EXPECT_EQ(m.bitCount(), 181); EXPECT_EQ(m.byteCount(), 23);
    }{
        Aesi m = "3204193290698947238931672972341151508380406116470290072152808452149735241615.";
        EXPECT_EQ(m.bitCount(), 251); EXPECT_EQ(m.byteCount(), 32);
    }{
        Aesi m = "1307947124275081320267802092014598881787726639944553485813418415062992248276001190919512309616545929415598763.";
        EXPECT_EQ(m.bitCount(), 360); EXPECT_EQ(m.byteCount(), 45);
    }{
        Aesi m = "28534850101898570474710141413913927972313704060038621588874963.";
        EXPECT_EQ(m.bitCount(), 205); EXPECT_EQ(m.byteCount(), 26);
    }{
        Aesi m = "186547211011565960360834677399752966883178428551654724629512194266072930.";
        EXPECT_EQ(m.bitCount(), 237); EXPECT_EQ(m.byteCount(), 30);
    }{
        Aesi m = "1369416445055542330663441898194145697102539611876570531.";
        EXPECT_EQ(m.bitCount(), 180); EXPECT_EQ(m.byteCount(), 23);
    }{
        Aesi m = "6148572308034937684753221787621890260678881623206328037140328020336862939698811176604453648297521709448290.";
        EXPECT_EQ(m.bitCount(), 352); EXPECT_EQ(m.byteCount(), 44);
    }{
        Aesi m = "51821718761454376853562798270553712164259354897877246623891326751545476237393228375021.";
        EXPECT_EQ(m.bitCount(), 285); EXPECT_EQ(m.byteCount(), 36);
    }{
        Aesi m = "444871851149431479626983465266102420775422.";
        EXPECT_EQ(m.bitCount(), 139); EXPECT_EQ(m.byteCount(), 18);
    }{
        Aesi m = "42146200574268847311698523498680873676706783693183222358186972843444316710.";
        EXPECT_EQ(m.bitCount(), 245); EXPECT_EQ(m.byteCount(), 31);
    }{
        Aesi m = "35453974191750223599443971448232408256392725686144289604176002346292.";
        EXPECT_EQ(m.bitCount(), 225); EXPECT_EQ(m.byteCount(), 29);
    }{
        Aesi m = "114399773536456471179538929162643059034663209191754021300097056704143055752447627827621176.";
        EXPECT_EQ(m.bitCount(), 296); EXPECT_EQ(m.byteCount(), 37);
    }{
        Aesi m = "306096489943631752388051638909060328435655026159556576651782659822077606.";
        EXPECT_EQ(m.bitCount(), 238); EXPECT_EQ(m.byteCount(), 30);
    }{
        Aesi m = "847445665267889245456213278113730865596260025864447116412907433580615172641770582449326549958998709878135166809715.";
        EXPECT_EQ(m.bitCount(), 379); EXPECT_EQ(m.byteCount(), 48);
    }{
        Aesi m = "855205585087312211296445789458057963768041132396148430034035722540576391486192631.";
        EXPECT_EQ(m.bitCount(), 269); EXPECT_EQ(m.byteCount(), 34);
    }{
        Aesi m = "7790374562144467155944484053910374470391879335804156417076224.";
        EXPECT_EQ(m.bitCount(), 203); EXPECT_EQ(m.byteCount(), 26);
    }{
        Aesi m = "4798011951051675050122476777454810968720955910594973468568707443382840023724197.";

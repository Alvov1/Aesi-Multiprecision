...
TEST(Initialization, DifferentPrecisions) {
    ...
    Multiprecision<96> o01 = iValue0;

    Multiprecision<128> o02 = iValue0; Multiprecision<160> o03 = iValue0; Multiprecision<192> o04 = iValue0; Multiprecision<224> o05 = iValue0; Multiprecision<256> o06 = iValue0; Multiprecision<288> o07 = iValue0; Multiprecision<320> o08 = iValue0; Multiprecision<352> o09 = iValue0;
...
TEST(Initialization, CopyConstruction) {
    Multiprecision<320> l0 = "856969574457709690462967066638280185610032288787864641536747837575250187179350463621579392244871."; Multiprecision<640> r0 = l0;
    EXPECT_EQ(r0, "856969574457709690462967066638280185610032288787864641536747837575250187179350463621579392244871.");
    Multiprecision<192> l1 = "1817464682414554777634009954620732846679878578413134368229."; Multiprecision<576> r1 = l1;
    EXPECT_EQ(r1, "1817464682414554777634009954620732846679878578413134368229.");
    Multiprecision<288> l2 = "273585059134613895932021029292354478649861471872302821549505743650758591411133430451408."; Multiprecision<512> r2 = l2;
    EXPECT_EQ(r2, "273585059134613895932021029292354478649861471872302821549505743650758591411133430451408.");
    Multiprecision<96> l3 = "16848821812072936343963016744."; Multiprecision<576> r3 = l3;
    EXPECT_EQ(r3, "16848821812072936343963016744.");
    Multiprecision<256> l4 = "89425012188150576676147569796603714593119677771166340023586622845972385164563."; Multiprecision<608> r4 = l4;
    EXPECT_EQ(r4, "89425012188150576676147569796603714593119677771166340023586622845972385164563.");
    Multiprecision<128> l5 = "295375145424713840341444584487141559072."; Multiprecision<352> r5 = l5;
    EXPECT_EQ(r5, "295375145424713840341444584487141559072.");
    Multiprecision<288> l6 = "339499853026571984978143860631483264809110095600112495957713684212166920280720856537507."; Multiprecision<512> r6 = l6;
    EXPECT_EQ(r6, "339499853026571984978143860631483264809110095600112495957713684212166920280720856537507.");
    Multiprecision<224> l7 = "25304709703351498872407921001491752489198569317853002340745585561130."; Multiprecision<512> r7 = l7;
    EXPECT_EQ(r7, "25304709703351498872407921001491752489198569317853002340745585561130.");
    Multiprecision<256> l8 = "113561681989557162025191006677416332468760445588423923562428981656155174119038."; Multiprecision<544> r8 = l8;
    EXPECT_EQ(r8, "113561681989557162025191006677416332468760445588423923562428981656155174119038.");
    Multiprecision<160> l9 = "492906146523434665001337396377408716037187766713."; Multiprecision<544> r9 = l9;
    EXPECT_EQ(r9, "492906146523434665001337396377408716037187766713.");
    Multiprecision<320> l10 = "1298781122230094131066140892218880004926912293801695693149260137199378490485067000212313855524472."; Multiprecision<448> r10 = l10;
    EXPECT_EQ(r10, "1298781122230094131066140892218880004926912293801695693149260137199378490485067000212313855524472.");
    Multiprecision<192> l11 = "85527839737441623387596737943574069844258992761886791264."; Multiprecision<512> r11 = l11;
    EXPECT_EQ(r11, "85527839737441623387596737943574069844258992761886791264.");
    Multiprecision<128> l12 = "22115878739988382109358311456734219104."; Multiprecision<544> r12 = l12;
    EXPECT_EQ(r12, "22115878739988382109358311456734219104.");
    Multiprecision<96> l13 = "49475628611456277257242336001."; Multiprecision<544> r13 = l13;
    EXPECT_EQ(r13, "49475628611456277257242336001.");
    Multiprecision<288> l14 = "56671084328196451986849244082695509909817145587284637777749032936926262765481285182134."; Multiprecision<416> r14 = l14;
    EXPECT_EQ(r14, "56671084328196451986849244082695509909817145587284637777749032936926262765481285182134.");
    Multiprecision<192> l15 = "3544498225942911223590252920351612557423834077300495237770."; Multiprecision<352> r15 = l15;
    EXPECT_EQ(r15, "3544498225942911223590252920351612557423834077300495237770.");
    Multiprecision<192> l16 = "3820599076383766096263039217201155696262014013686177183435."; Multiprecision<416> r16 = l16;
    EXPECT_EQ(r16, "3820599076383766096263039217201155696262014013686177183435.");
    Multiprecision<96> l17 = "57599326491869816621963559440."; Multiprecision<640> r17 = l17;
    EXPECT_EQ(r17, "57599326491869816621963559440.");
    Multiprecision<160> l18 = "398621409139070063759305124012533025860694318871."; Multiprecision<608> r18 = l18;
    EXPECT_EQ(r18, "398621409139070063759305124012533025860694318871.");
    Multiprecision<320> l19 = "248316872826048034227114052633289726014974581360870214968041723567293448101375940146375519025610."; Multiprecision<352> r19 = l19;
    EXPECT_EQ(r19, "248316872826048034227114052633289726014974581360870214968041723567293448101375940146375519025610.");

    Multiprecision<608> l20 = "480748306912701683551026904120451207851157046496025514603903733409124634475655295590263438367593131754374865349097113977359141809844045727298373624458221965327208187046764425885989375.";
    Multiprecision<96> r20 = l20; EXPECT_EQ(r20, "7315839924642923755123456511.");
    Multiprecision<384> l21 = "24732712984347763863686063342763357230152897395584545075070515616089388988095271904791330759237060982754926527148659.";
    Multiprecision<128> r21 = l21; EXPECT_EQ(r21, "276593900546481545361984775786702991987.");
    Multiprecision<384> l22 = "25265080169480331943217304297776392543015169251561211370971697299949969674628417070404543397222311206461399768507413.";
    Multiprecision<192> r22 = l22; EXPECT_EQ(r22, "5427574012535137818718507120413538908796299709273432400917.");
    Multiprecision<544> l23 = "51745623400592303273488368459034916606144660476304319387847981608773906660582998678767323241739412296092733302695015801193856715621466668157630426069181035184679156.";
    Multiprecision<128> r23 = l23; EXPECT_EQ(r23, "48277504082481759000353990028204468468.");
    Multiprecision<640> l24 = "2483659815302037713246132972687567200992533059356141579944568310265888324863696400805396970092208056614613672365514009958609839094050108024653994093041593083792431501631630944271578577629096184.";
    Multiprecision<192> r24 = l24; EXPECT_EQ(r24, "2479783778105728395870394836207134923910444741150009993464.");
    Multiprecision<480> l25 = "2575444764979228256302972756555363258983850034223003439688891561318782119534456833559884731570576183810759624412115817433201040035214828423182040.";
    Multiprecision<160> r25 = l25; EXPECT_EQ(r25, "678578983352461974029650041212752611069554161368.");
    Multiprecision<352> l26 = "6447444378744195218140254845048874447093869507850770757516522265101456245432283131966757618231045311275742.";
    Multiprecision<96> r26 = l26; EXPECT_EQ(r26, "28425401103843126580300325598.");
    Multiprecision<480> l27 = "994436160823845050116679985411979610820612109057253361937912071612950806651752613535023596299841105763992170915210059597788845237818885529822885.";
    Multiprecision<256> r27 = l27; EXPECT_EQ(r27, "84749325263055339442963923121992410225629138360736796140135959251605670749861.");
    Multiprecision<512> l28 = "11675072289569369370637177529427320811004043093738351423810014974101379207770749479775777216322323111873129448755953546751654776241818136245314659030835976.";
    Multiprecision<192> r28 = l28; EXPECT_EQ(r28, "2976371073428599466223411603937197263712729513112299545352.");
    Multiprecision<448> l29 = "219815026951655971061040887493048537575925564844708161716220465836587034762546971034698314904015255075296497325403919563298509665586491.";
    Multiprecision<128> r29 = l29; EXPECT_EQ(r29, "295116307160859791396010484912615050555.");
    Multiprecision<640> l30 = "1830881751462381294753718092869867337284273557348663989645594378121754617183058738777858020089460582636217187006034826757571951771627291712145118998043450989696100518065114441444487605022011180.";
    Multiprecision<256> r30 = l30; EXPECT_EQ(r30, "8958889727000130083485224995263070146065328843751127247768740464026098249516.");
    Multiprecision<448> l31 = "296932102348854834261141373273572906583691861479751578338365647160839113748367350360938651050110927850688650658575786620891664204314149.";
    Multiprecision<288> r31 = l31; EXPECT_EQ(r31, "396450197407333239118602857604013002149492692004445494305179535751775133157549266581029.");
    Multiprecision<576> l32 = "241958040428506665397698526697657254487495059616873909245932880996748501717028189503013348796772267784641030910857023369803763662693806273473556437047102016711022006537966850.";
    Multiprecision<128> r32 = l32; EXPECT_EQ(r32, "295702489753947751894198331394795394306.");
    Multiprecision<480> l33 = "1310351347503661216897612434294681162938417202645981065894559841116932759717150274773175006485302032046996163492417938457974972276983262045728603.";
    Multiprecision<160> r33 = l33; EXPECT_EQ(r33, "351113845345664714346131860917895061411534925659.");
    Multiprecision<352> l34 = "1515829831287265514002624168838526063861459069032586902881374788429757813036157336399942353423383649894443.";
    Multiprecision<256> r34 = l34; EXPECT_EQ(r34, "18289382377494143608247833819288947325624502588516708023779061379520056311851.");
    Multiprecision<512> l35 = "8042235538536782266783946070420140382943166349620298785958420047897761190898834350374170437023348481199234025976425566442360741411104540457455789544927007.";
    Multiprecision<128> r35 = l35; EXPECT_EQ(r35, "139039142689008298202686827231104560927.");
    Multiprecision<448> l36 = "162907801127962717251082455693406896878007900268804686977536204715384900250930480801348587978712333516922017803477107543643677590789771.";
    Multiprecision<160> r36 = l36; EXPECT_EQ(r36, "481047254507856721807620347743073032727556759179.");
    Multiprecision<448> l37 = "96057392907500153858333509155852412483644876791355916222379185306505865121174693102600304587232372621281510615110305873205540709529902.";
    Multiprecision<192> r37 = l37; EXPECT_EQ(r37, "2162594323210120305985950610806219485640440144750136850734.");
    Multiprecision<544> l38 = "5757066267316319477508877363463974751181033059683780026672648777320786034173156480174153805057640005656918250673476649133642684366906989776616930253727649075889040.";
    Multiprecision<256> r38 = l38; EXPECT_EQ(r38, "106933706339764000878509010506267008707527642239213681219687340160313450627984.");
    Multiprecision<416> l39 = "86605218842175287861295312762812733538876615816577435089539372437460337976422690938739296779379732680027937815494246618893146.";
    Multiprecision<320> r39 = l39; EXPECT_EQ(r39, "1000120221928044347333617422540787789504562475931143059065186465720343014110720116619366564105050.");
}
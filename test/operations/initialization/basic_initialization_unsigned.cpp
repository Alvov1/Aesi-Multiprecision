...
TEST(Initialization, BasicInitializationUnsigned) {
    Aeu512 m0 {};
    EXPECT_EQ(m0, 0);
    ...
    Aeu512 m7 = "Somebody once told me The world is gonna roll me I ain't the sharpest tool in the shed";
    EXPECT_EQ(m7, 0);

    Aeu512 i01 = 1;
    EXPECT_EQ(i01, 1);

    Aeu512 i02 = 1, i03 = 127, i05 = 128;
    EXPECT_EQ(i02, 1); EXPECT_NE(i02, 1); 
    EXPECT_EQ(i03, 127); EXPECT_NE(i03, 127); 
    EXPECT_EQ(i05, 128); EXPECT_NE(i05, 128);
}

TEST(Initialization, SmallCharArrayInitializationUnsigned) {
    Aeu512 ten = "10";
    EXPECT_EQ(ten, 10);

    Aeu512 hexTenLC = "0xa", hexTenHC = "0xA";
    EXPECT_EQ(hexTenLC, 10); EXPECT_EQ(hexTenHC, 10);
}

TEST(Initialization, StringStringViewInitializationUnsigned) {
    using namespace std::string_literals;
    using namespace std::string_view_literals;

    Aeu512 d0 = "489133282872437279"s;
    EXPECT_EQ(d0, 489133282872437279);
    Aeu512 d1 = "63018038201"sv;
    EXPECT_EQ(d1, 63018038201);
    Aeu512 d2 = "489133282872437279"s;
    EXPECT_EQ(d2, 489133282872437279);
    Aeu512 d3 = "63018038201"sv;
    EXPECT_EQ(d3, 63018038201);

    Aeu512 b0 = "0b11011001001110000000010000100010101011011101010101000011111"s;
    EXPECT_EQ(b0, 489133282872437279);
    Aeu512 b1 = "0b111010101100001010101111001110111001"sv;
    EXPECT_EQ(b1, 63018038201);
    Aeu512 b2 = "0b11011001001110000000010000100010101011011101010101000011111"s;
    EXPECT_EQ(b2, 489133282872437279);
    Aeu512 b3 = "0b111010101100001010101111001110111001"sv;
    EXPECT_EQ(b3, 63018038201);

    Aeu512 o0 = "0o106274176273174613"s;
    EXPECT_EQ(o0, 2475842268363147);
    Aeu512 o1 = "0o642054234601645202742"sv;
    EXPECT_EQ(o1, 7531577461358003682);
    Aeu512 o2 = "0o106274176273174613"s;
    EXPECT_EQ(o2, 2475842268363147);
    Aeu512 o3 = "0o642054234601645202742"sv;
    EXPECT_EQ(o3, 7531577461358003682);

    Aeu512 h0 = "0x688589CC0E9505E2"s;
    EXPECT_EQ(h0, 7531577461358003682);
    Aeu512 h1 = "0x3C9D4B9CB52FE"sv;
    EXPECT_EQ(h1, 1066340417491710);
    Aeu512 h2 = "0x688589CC0E9505E2"s;
    EXPECT_EQ(h2, 7531577461358003682);
    Aeu512 h3 = "0x3C9D4B9CB52FE"sv;
    EXPECT_EQ(h3, 1066340417491710);
    Aeu512 h4 = "0x688589cc0e9505e2"s;
    EXPECT_EQ(h4, 7531577461358003682);
    Aeu512 h5 = "0x3c9d4b9cb52fe"sv;
    EXPECT_EQ(h5, 1066340417491710);
    Aeu512 h6 = "0x688589cc0e9505e2"s;
    EXPECT_EQ(h6, 7531577461358003682);
    Aeu512 h7 = "0x3c9d4b9cb52fe"sv;
...
TEST(Initialization, DifferentPrecisionsUnsigned) {
    ...
    Aeu < 96 > o20 = iValue2;
    Aeu < 96 > o21 = iValue2; Aeu < 128 > o22 = iValue2; Aeu < 160 > o23 = iValue2; Aeu < 192 > o24 = iValue2; Aeu < 224 > o25 = iValue2; Aeu < 256 > o26 = iValue2; Aeu < 288 > o27 = iValue2; Aeu < 320 > o28 = iValue2; Aeu < 352 > o29 = iValue2;
    Aeu < 384 > o210 = iValue2; Aeu < 416 > o211 = iValue2; Aeu < 448 > o212 = iValue2; Aeu < 480 > o213 = iValue2; Aeu < 512 > o214 = iValue2; Aeu < 544 > o215 = iValue2; Aeu < 576 > o216 = iValue2; Aeu < 608 > o217 = iValue2; Aeu < 640 > o218 = iValue2;
    Aeu < 672 > o219 = iValue2; Aeu < 704 > o220 = iValue2; Aeu < 736 > o221 = iValue2; Aeu < 768 > o222 = iValue2; Aeu < 800 > o223 = iValue2; Aeu < 832 > o224 = iValue2; Aeu < 864 > o225 = iValue2; Aeu < 896 > o226 = iValue2; Aeu < 928 > o227 = iValue2;
    Aeu < 960 > o228 = iValue2; Aeu < 992 > o229 = iValue2; Aeu < 1024 > o230 = iValue2; Aeu < 1056 > o231 = iValue2; Aeu < 1088 > o232 = iValue2; Aeu < 1120 > o233 = iValue2; Aeu < 1152 > o234 = iValue2; Aeu < 1184 > o235 = iValue2; Aeu < 1216 > o236 = iValue2;
    Aeu < 1248 > o237 = iValue2; Aeu < 1280 > o238 = iValue2; Aeu < 1312 > o239 = iValue2;
    ...
    Aeu < 96 > o40 = iValue4;
    Aeu < 96 > o41 = iValue4; Aeu < 128 > o42 = iValue4; Aeu < 160 > o43 = iValue4; Aeu < 192 > o44 = iValue4; Aeu < 224 > o45 = iValue4; Aeu < 256 > o46 = iValue4; Aeu < 288 > o47 = iValue4; Aeu < 320 > o48 = iValue4; Aeu < 352 > o49 = iValue4;
    Aeu < 384 > o410 = iValue4; Aeu < 416 > o411 = iValue4; Aeu < 448 > o412 = iValue4; Aeu < 480 > o413 = iValue4; Aeu < 512 > o414 = iValue4; Aeu < 544 > o415 = iValue4; Aeu < 576 > o416 = iValue4; Aeu < 608 > o417 = iValue4; Aeu < 640 > o418 = iValue4;
    Aeu < 672 > o419 = iValue4; Aeu < 704 > o420 = iValue4; Aeu < 736 > o421 = iValue4; Aeu < 768 > o422 = iValue4; Aeu < 800 > o423 = iValue4; Aeu < 832 > o424 = iValue4; Aeu < 864 > o425 = iValue4; Aeu < 896 > o426 = iValue4; Aeu < 928 > o427 = iValue4;
    Aeu < 960 > o428 = iValue4; Aeu < 992 > o429 = iValue4; Aeu < 1024 > o430 = iValue4; Aeu < 1056 > o431 = iValue4; Aeu < 1088 > o432 = iValue4; Aeu < 1120 > o433 = iValue4; Aeu < 1152 > o434 = iValue4; Aeu < 1184 > o435 = iValue4; Aeu < 1216 > o436 = iValue4;
    Aeu < 1248 > o437 = iValue4; Aeu < 1280 > o438 = iValue4; Aeu < 1312 > o439 = iValue4;
    ...
    Aeu < 96 > o60 = iValue6;
    Aeu < 96 > o61 = iValue6; Aeu < 128 > o62 = iValue6; Aeu < 160 > o63 = iValue6; Aeu < 192 > o64 = iValue6; Aeu < 224 > o65 = iValue6; Aeu < 256 > o66 = iValue6; Aeu < 288 > o67 = iValue6; Aeu < 320 > o68 = iValue6; Aeu < 352 > o69 = iValue6;
    Aeu < 384 > o610 = iValue6; Aeu < 416 > o611 = iValue6; Aeu < 448 > o612 = iValue6; Aeu < 480 > o613 = iValue6; Aeu < 512 > o614 = iValue6; Aeu < 544 > o615 = iValue6; Aeu < 576 > o616 = iValue6; Aeu < 608 > o617 = iValue6; Aeu < 640 > o618 = iValue6;
    Aeu < 672 > o619 = iValue6; Aeu < 704 > o620 = iValue6; Aeu < 736 > o621 = iValue6; Aeu < 768 > o622 = iValue6; Aeu < 800 > o623 = iValue6; Aeu < 832 > o624 = iValue6; Aeu < 864 > o625 = iValue6; Aeu < 896 > o626 = iValue6; Aeu < 928 > o627 = iValue6;
    Aeu < 960 > o628 = iValue6; Aeu < 992 > o629 = iValue6; Aeu < 1024 > o630 = iValue6; Aeu < 1056 > o631 = iValue6; Aeu < 1088 > o632 = iValue6; Aeu < 1120 > o633 = iValue6; Aeu < 1152 > o634 = iValue6; Aeu < 1184 > o635 = iValue6; Aeu < 1216 > o636 = iValue6;
    Aeu < 1248 > o637 = iValue6; Aeu < 1280 > o638 = iValue6; Aeu < 1312 > o639 = iValue6;
    ...
    Aeu < 96 > o80 = iValue8;
    Aeu < 96 > o81 = iValue8; Aeu < 128 > o82 = iValue8; Aeu < 160 > o83 = iValue8; Aeu < 192 > o84 = iValue8; Aeu < 224 > o85 = iValue8; Aeu < 256 > o86 = iValue8; Aeu < 288 > o87 = iValue8; Aeu < 320 > o88 = iValue8; Aeu < 352 > o89 = iValue8;
    Aeu < 384 > o810 = iValue8; Aeu < 416 > o811 = iValue8; Aeu < 448 > o812 = iValue8; Aeu < 480 > o813 = iValue8; Aeu < 512 > o814 = iValue8; Aeu < 544 > o815 = iValue8; Aeu < 576 > o816 = iValue8; Aeu < 608 > o817 = iValue8; Aeu < 640 > o818 = iValue8;
    Aeu < 672 > o819 = iValue8; Aeu < 704 > o820 = iValue8; Aeu < 736 > o821 = iValue8; Aeu < 768 > o822 = iValue8; Aeu < 800 > o823 = iValue8; Aeu < 832 > o824 = iValue8; Aeu < 864 > o825 = iValue8; Aeu < 896 > o826 = iValue8; Aeu < 928 > o827 = iValue8;
    Aeu < 960 > o828 = iValue8; Aeu < 992 > o829 = iValue8; Aeu < 1024 > o830 = iValue8; Aeu < 1056 > o831 = iValue8; Aeu < 1088 > o832 = iValue8; Aeu < 1120 > o833 = iValue8; Aeu < 1152 > o834 = iValue8; Aeu < 1184 > o835 = iValue8; Aeu < 1216 > o836 = iValue8;
    Aeu < 1248 > o837 = iValue8; Aeu < 1280 > o838 = iValue8; Aeu < 1312 > o839 = iValue8;

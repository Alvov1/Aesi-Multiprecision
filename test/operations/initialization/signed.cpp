...
TEST(Signed_Initialization, Basic) {
    ...
    EXPECT_EQ(Aesi512(L"489133282872437279"s), 489133282872437279);
    EXPECT_EQ(Aesi512(L"63018038201"sv), 63018038201);
    EXPECT_EQ(Aesi512(L"-489133282872437279"s), -489133282872437279);
    EXPECT_EQ(Aesi512(L"-63018038201"sv), -63018038201);

    EXPECT_EQ(Aesi512(L"0b11011001001110000000010000100010101011011101010101000011111"s), 489133282872437279);
    EXPECT_EQ(Aesi512(L"0b111010101100001010101111001110111001"sv), 63018038201);
    EXPECT_EQ(Aesi512(L"-0b11011001001110000000010000100010101011011101010101000011111"s), -489133282872437279);
    EXPECT_EQ(Aesi512(L"-0b111010101100001010101111001110111001"sv), -63018038201);
    ...
    EXPECT_EQ(Aesi512(L"0o106274176273174613"s), 2475842268363147);
    EXPECT_EQ(Aesi512(L"0o642054234601645202742"sv), 7531577461358003682);
    EXPECT_EQ(Aesi512(L"-0o106274176273174613"s), -2475842268363147);
    EXPECT_EQ(Aesi512(L"-0o642054234601645202742"sv), -7531577461358003682);

    EXPECT_EQ(Aesi512(L"0x688589CC0E9505E2"s), 7531577461358003682);
    EXPECT_EQ(Aesi512(L"0x3C9D4B9CB52FE"sv), 1066340417491710);
    EXPECT_EQ(Aesi512(L"-0x688589CC0E9505E2"s), -7531577461358003682);
    EXPECT_EQ(Aesi512(L"-0x3C9D4B9CB52FE"sv), -1066340417491710);

...
/* ------------------------------------------- Greatest common divisor -------------------------------------------- */
    ...
    constexpr Multiprecision<bitness>
    gcd(const Multiprecision<bitness> &first, const Multiprecision<bitness> &second) noexcept {
        return {};
    }
...
/* ----------------------------------------------- Power by modulo ------------------------------------------------ */
    template<std::size_t bitness>
    constexpr Multiprecision<bitness> powm(const Multiprecision<bitness> &base, const Multiprecision<bitness> &power,
                                           const Multiprecision<bitness> &mod) {
        return {};
    }
    ...
    constexpr auto
    powm(const Multiprecision<bBase> &base, const Multiprecision<bPow> &power, const Multiprecision<bMod> &mod)
